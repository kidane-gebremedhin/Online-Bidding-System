...
//tenders 
Route::get('/tenders-create', 'tenderController@create')->name('tenders.create');
Route::get('/tenders-show/{id}', 'tenderController@show')->name('tenders.show');
Route::get('/tenders-edit/{id}', 'tenderController@edit')->name('tenders.edit');
Route::post('/tenders-update/{id}', 'tenderController@update')->name('tenders.update');
Route::get('/tenders-index', 'tenderController@index')->name('tenders.index');
Route::post('/tenders-store', 'tenderController@store')->name('tenders.store');
Route::get('/tenders-confirm_delete/{id}', 'tenderController@delete')->name('tenders.delete');
Route::get('/tenders-destroy/{id}', 'tenderController@destroy')->name('tenders.destroy');
Route::get('/tenders_like/{id}', 'tenderController@like')->name('tenders.like');
Route::get('/tenders_pin/{id}', 'tenderController@pin')->name('tenders.pin');

Route::get('/pined_tenders', 'tenderController@pinedTenders')->name('tenders.pined');
Route::get('/liked_tenders', 'tenderController@likedTenders')->name('tenders.liked');
...
Route::get('/companies-confirm_delete/{id}', 'companyController@delete')->name('companies.delete');
...
Route::get('/classes-show/{id}', 'classController@show')->name('classes.show');
Route::get('/classes-edit/{id}', 'classController@edit')->name('classes.edit');
Route::post('/classes-update/{id}', 'classController@update')->name('classes.update');
Route::get('/classes-index', 'classController@index')->name('classes.index');
Route::post('/classes-store', 'classController@store')->name('classes.store');
Route::get('/classes-confirm_delete/{id}', 'classController@delete')->name('classes.delete');
Route::get('/classes-destroy/{id}', 'classController@destroy')->name('classes.destroy');

//subscription_plans 
Route::get('/subscription_plans-create', 'subscription_planController@create')->name('subscription_plans.create');
Route::get('/subscription_plans-show/{id}', 'subscription_planController@show')->name('subscription_plans.show');
Route::get('/subscription_plans-edit/{id}', 'subscription_planController@edit')->name('subscription_plans.edit');
Route::post('/subscription_plans-update/{id}', 'subscription_planController@update')->name('subscription_plans.update');
Route::get('/subscription_plans-index', 'subscription_planController@index')->name('subscription_plans.index');
Route::post('/subscription_plans-store', 'subscription_planController@store')->name('subscription_plans.store');
Route::get('/subscription_plans-confirm_delete/{id}', 'subscription_planController@delete')->name('subscription_plans.delete');
Route::get('/subscription_plans-destroy/{id}', 'subscription_planController@destroy')->name('subscription_plans.destroy');
...
Route::post('/ads-update/{id}', 'adController@update')->name('ads.update');
Route::get('/ads-index', 'adController@index')->name('ads.index');
Route::post('/ads-store', 'adController@store')->name('ads.store');
Route::get('/ads-confirm_delete/{id}', 'adController@delete')->name('ads.delete');
Route::get('/ads-destroy/{id}', 'adController@destroy')->name('ads.destroy');

//business_categories 
Route::get('/business_categories-create', 'business_categoryController@create')->name('business_categories.create');
Route::get('/business_categories-show/{id}', 'business_categoryController@show')->name('business_categories.show');
Route::get('/business_categories-edit/{id}', 'business_categoryController@edit')->name('business_categories.edit');
Route::post('/business_categories-update/{id}', 'business_categoryController@update')->name('business_categories.update');
Route::get('/business_categories-index', 'business_categoryController@index')->name('business_categories.index');
Route::post('/business_categories-store', 'business_categoryController@store')->name('business_categories.store');
Route::get('/business_categories-confirm_delete/{id}', 'business_categoryController@delete')->name('business_categories.delete');
Route::get('/business_categories-destroy/{id}', 'business_categoryController@destroy')->name('business_categories.destroy');
