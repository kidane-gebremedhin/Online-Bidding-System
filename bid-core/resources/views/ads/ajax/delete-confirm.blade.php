<div class="col-md-12">
	<div class="col-md-12">
		<h4 class="text-danger">
			...
			<a href="{{route('ads.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('ads.destroy', $ad->id)}}"> 
				{{App\Global_var::getLangString('No', $language_strings)}}
			</a>
			<a href="{{route('ads.destroy', $ad->id)}}" value="{{$ad->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('ads.index')}}"><i class="fa fa-trash"></i> 
