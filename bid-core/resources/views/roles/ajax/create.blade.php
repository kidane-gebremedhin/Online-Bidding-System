<div class="col-md-12">
  <div class="col-md-10 col-md-offset-1">
    {{Form::open(array("route"=>"roles.store", "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('roles.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {{App\Global_var::getLangString('Create_New_role', $language_strings)}}
        ...
        <div class="col-md-10" style="padding-top:15px;">
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="form-group col-md-8">
              {{Form::textarea('remark', null, array('class'=>'formatted form-control', 'rows'=>'3'));}}
            </div>
          </div>
          <div class="col-md-12 form-group">
