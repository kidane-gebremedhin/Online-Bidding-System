                    ...
                    <div class="col-md-4"> 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('lastName', null, array('class'=>'lastName author_elem form-control', 'required'=>'true'))}}
                            </div>
                            <div class="form-group">
                                <label class="control-label"> {{App\Global_var::getLangString('Middle_Name', $language_strings)}}</label>
                                {{ Form::text('middleName', null, array('class'=>'middleName author_elem form-control', 'required'=>'true'))}}
                            </div>
                            <div class="form-group">
