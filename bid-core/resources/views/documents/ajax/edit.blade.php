            ...
            <div class="panel-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="orgDetails">
                        {!!Form::model($document, array("route"=>["documents.update", $document->id], "method"=>"POST", "class"=>"post"))!!}
                    ...
                    <div class="col-md-4"> 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('lastName', $document->author!=null? $document->author->lastName: null, array('class'=>'lastName author_elem form-control', 'required'=>'true'))}}
                            </div>
                            <div class="form-group">
                                <label class="control-label"> {{App\Global_var::getLangString('Middle_Name', $language_strings)}}</label>
                                {{ Form::text('middleName', $document->author!=null? $document->author->middleName: null, array('class'=>'middleName author_elem form-control', 'required'=>'true'))}}
                            </div>
                            <div class="form-group">
