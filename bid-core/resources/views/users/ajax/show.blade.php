			...
			<div class="panel-body">
				<table class="table">
					<tbody>
						...
						<tr>
							<td class="col-md-4">{{App\Global_var::getLangString('Business_Category', $language_strings)}}</td><td><h4>{{$user->businessCategory!=null? $user->businessCategory->name: ''}}</h4></td>
						</tr>
						<tr>
							<td class="col-md-4">{{App\Global_var::getLangString('Subscription_Plan', $language_strings)}}</td><td><h4>{{$user->subscriptionPlan!=null? $user->subscriptionPlan->name: ''}}</h4></td>
						</tr>
						<tr>
							<td class="col-md-4">{{App\Global_var::getLangString('Full_Name', $language_strings)}}</td><td><h4>{{$user->fullName}}</h4></td>
						</tr>
						<tr>
							<td class="col-md-4">{{App\Global_var::getLangString('Company_Name', $language_strings)}}</td><td><h4>{{$user->companyName}}</h4></td>
						</tr>
						<tr>
