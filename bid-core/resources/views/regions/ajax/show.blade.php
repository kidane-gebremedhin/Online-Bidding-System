	...
	<div class="col-md-8 ">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h4> 
					...
					<a href="{{route('regions.index')}}" class="get btn btn-success btn-sm pull-right" nextUrl="{{route('regions.index')}}"><i class="fa fa-eye"></i> <strong>
		...
		<div class="col-md-10">
			...
			<div class="col-md-4">
				...
				<a href="{{route('regions.edit', $region->id)}}" value="{{$region->id}}" class="get btn btn-primary" nextUrl="{{route('regions.edit', $region->id)}}"><i class="fa fa-edit"></i> 
					{{App\Global_var::getLangString('Edit', $language_strings)}}
				</a>
				<a href="{{route('regions.delete', $region->id)}}" value="{{$region->id}}" class="get btn btn-danger" nextUrl="{{route('regions.delete', $region->id)}}"><i class="fa fa-trash"></i> 
