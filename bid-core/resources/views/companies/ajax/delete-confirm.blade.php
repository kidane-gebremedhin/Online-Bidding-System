<div class="col-md-12">
	<div class="col-md-12">
		<h4 class="text-danger">
			...
			<a href="{{route('companies.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('companies.destroy', $company->id)}}"> 
				{{App\Global_var::getLangString('No', $language_strings)}}
			</a>
			<a href="{{route('companies.destroy', $company->id)}}" value="{{$company->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('companies.index')}}"><i class="fa fa-trash"></i> 
