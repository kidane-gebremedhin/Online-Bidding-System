<div class="col-md-12">
  <div class="col-md-8">
    {{Form::open(array("route"=>"business_categories.store", "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('business_categories.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {{App\Global_var::getLangString('Create_New_Business_Category', $language_strings)}}
