...
<hr>
	...
	<a href="{{route('business_categories.edit', $business_category->id)}}" value="{{$business_category->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('business_categories.edit', $business_category->id)}}"><i class="fa fa-edit"></i> 
		{{App\Global_var::getLangString('Edit', $language_strings)}}
	</a>
	<a href="{{route('business_categories.delete', $business_category->id)}}" value="{{$business_category->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('business_categories.delete', $business_category->id)}}"><i class="fa fa-trash"></i> 
