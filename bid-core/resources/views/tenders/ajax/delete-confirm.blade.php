<div class="col-md-12">
	<div class="col-md-12">
		<h4 class="text-danger">
			...
			<a href="{{route('tenders.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('tenders.destroy', $tender->id)}}"> 
				{{App\Global_var::getLangString('No', $language_strings)}}
			</a>
			<a href="{{route('tenders.destroy', $tender->id)}}" value="{{$tender->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('tenders.index')}}"><i class="fa fa-trash"></i> 
