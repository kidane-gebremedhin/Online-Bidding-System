...
if($role==null){
  ...
  public function insertResources(){
        ...
        $resources = array(
          ...
          'business_categories' => array('true', 2, 'business_categories'),           
          'companies' => array('true', 2, 'companies'),           
          'tenders' => array('true', 2, 'tenders'),           
          'subscription_plans' => array('true', 2, 'subscription_plans'),           
          'classes' => array('true', 2, 'classes'),           
